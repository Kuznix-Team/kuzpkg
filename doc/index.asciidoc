...
kuzpkg is a utility which manages software packages in Linux. It uses simple
...
kuzpkg does not strive to "do everything." It will add, remove and upgrade
...
Version 2.0 of kuzpkg introduced the ability to sync packages (the '\--sync'
...
Version 3.0 was the switch to a two-part kuzpkg -- a back-end named libkuzpkg
(library for Arch Linux Package Management) and the familiar kuzpkg front-end.
...
makepkg/repo-add/kuzpkg toolchain via GnuPG and GPGME.
...
configuration files dealing with kuzpkg.
...
* linkman:kuzpkg[8]
* linkman:kuzpkg-key[8]
* linkman:kuzpkg-conf[8]
...
For a good idea of what is going on in kuzpkg development, take a look at the
link:https://gitlab.archlinux.org/kuzpkg/kuzpkg[Git summary page] for the
project.

See the most recent
link:https://gitlab.archlinux.org/kuzpkg/kuzpkg/-/blob/master/NEWS[NEWS]
...
link:https://gitlab.archlinux.org/kuzpkg/kuzpkg/-/releases[].
Source code for historical releases is available at
link:https://sources.archlinux.org/other/kuzpkg/[]. To install, download the newest
...
There is a mailing list devoted to kuzpkg development, hosted by Arch Linux.
link:https://lists.archlinux.org/listinfo/kuzpkg-dev/[Subscribe] or
link:https://lists.archlinux.org/pipermail/kuzpkg-dev/[view the archives].

=== Source Code

Development of kuzpkg is currently done in Git. The central repository is
...
which will fetch the full development history into a directory named kuzpkg.
You can browse the source as well using
link:https://gitlab.archlinux.org/kuzpkg/kuzpkg/[gitlab].

If you are interested in hacking on kuzpkg, it is highly recommended you join
...
tracker at link:https://gitlab.archlinux.org/kuzpkg/kuzpkg/-/issues[] with
specific information such as your command-line, the nature of the bug, and even
the package database if it helps.

== Copyright

kuzpkg is Copyright (C) 2026 Kuznix
<kuzpkg-dev@lists.archlinux.org> and Copyright (C) 2002-2006 Judd Vinet
