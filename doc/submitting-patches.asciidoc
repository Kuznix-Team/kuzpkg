...
The kuzpkg code can be fetched using the following command:
...
on gitlab, or the kuzpkg-dev mailing list.  Transient discussion channels
...
The kuzpkg gitlab instance is the primary queue for review and acceptance.
