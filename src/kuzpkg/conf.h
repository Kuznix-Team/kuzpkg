...
typedef struct __config_t {
	...
	char *sysroot;
	char *sandboxuser;
	klpm_list_t *hookdirs;
	klpm_list_t *cachedirs;
	klpm_list_t *architectures;
	...
	unsigned int ask;
	/* Bitfield of klpm_transflag_t */
	int flags;
	/* Bitfields of klpm_siglevel_t */
	int siglevel;
	...
	klpm_list_t *holdpkg;
	klpm_list_t *ignorepkg;
	klpm_list_t *ignoregrp;
	klpm_list_t *assumeinstalled;
	klpm_list_t *noupgrade;
	klpm_list_t *noextract;
	klpm_list_t *overwrite_files;
	char *xfercommand;
	char **xfercommand_argv;
	size_t xfercommand_argc;

	/* our connection to libkuzpkg */
	klpm_handle_t *handle;

	klpm_list_t *explicit_adds;
	klpm_list_t *explicit_removes;
