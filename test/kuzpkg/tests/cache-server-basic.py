...
# TODO: hack to prevent kuzpkg trying to validate the downloaded packages
p404 = pmpkg('pkg404')
...
#self.addrule("KUZPKG_RETCODE=0") # TODO
self.addrule("KUZPKG_OUTPUT={}".format(normal_url.replace("http://", "")))
self.addrule("!KUZPKG_OUTPUT={}".format(cache_url.replace("http://", "")))
