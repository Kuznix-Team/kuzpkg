self.description = "kuzpkg-db-upgrade DB version 9 (symlink support removal)"
...
self.cmd = ["kuzpkg-db-upgrade",
        "--root", self.rootdir(),
        "--dbpath", self.dbdir(),
        "--config", self.configfile() ]

self.addrule("KUZPKG_RETCODE=0")
self.addrule("FILE_EXIST=var/lib/kuzpkg/local/KUZPKG_DB_VERSION")
